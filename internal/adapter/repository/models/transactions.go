...
type Transaction struct {
	...
	DestinationAccountID string      `boil:"destination_account_id" json:"destination_account_id" toml:"destination_account_id" yaml:"destination_account_id"`
	Payee                null.String `boil:"payee" json:"payee,omitempty" toml:"payee" yaml:"payee,omitempty"`
	...
	MethodOfPayment      null.String `boil:"method_of_payment" json:"method_of_payment,omitempty" toml:"method_of_payment" yaml:"method_of_payment,omitempty"`
...
var TransactionTableColumns = struct {
	...
	SourceAccountID:      "transactions.source_account_id",
	DestinationAccountID: "transactions.destination_account_id",
	Payee:                "transactions.payee",
	CategoryID:           "transactions.category_id",
	Description:          "transactions.description",
	MethodOfPayment:      "transactions.method_of_payment",
...
var TransactionWhere = struct {
	...
	DestinationAccountID whereHelperstring
	Payee                whereHelpernull_String
	CategoryID           whereHelpernull_String
	Description          whereHelpernull_String
	MethodOfPayment      whereHelpernull_String
	...
	Pending:              whereHelperbool{field: "\"transactions\".\"pending\""},
	Type:                 whereHelperstring{field: "\"transactions\".\"type\""},
	SourceAccountID:      whereHelperstring{field: "\"transactions\".\"source_account_id\""},
	DestinationAccountID: whereHelperstring{field: "\"transactions\".\"destination_account_id\""},
	Payee:                whereHelpernull_String{field: "\"transactions\".\"payee\""},
	CategoryID:           whereHelpernull_String{field: "\"transactions\".\"category_id\""},
	Description:          whereHelpernull_String{field: "\"transactions\".\"description\""},
	MethodOfPayment:      whereHelpernull_String{field: "\"transactions\".\"method_of_payment\""},
...
var (
	transactionAllColumns            = []string{"id", "amount", "pending", "type", "source_account_id", "destination_account_id", "payee", "category_id", "description", "method_of_payment", "created", "updated"}
	transactionColumnsWithoutDefault = []string{"amount", "type", "source_account_id", "destination_account_id"}
	transactionColumnsWithDefault    = []string{"id", "pending", "payee", "category_id", "description", "method_of_payment", "created", "updated"}
...
func FindTransaction(ctx context.Context, exec boil.ContextExecutor, iD null.String, selectCols ...string) (*Transaction, error) {
...
func TransactionExists(ctx context.Context, exec boil.ContextExecutor, iD null.String) (bool, error) {
	var exists bool
