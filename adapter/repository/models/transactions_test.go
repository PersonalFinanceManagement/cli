...
var (
	transactionDBTypes = map[string]string{`ID`: `TEXT`, `Amount`: `INTEGER`, `Pending`: `BOOLEAN`, `Type`: `TEXT`, `SourceAccountID`: `TEXT`, `DestinationAccountID`: `TEXT`, `Payee`: `TEXT`, `CategoryID`: `TEXT`, `Description`: `TEXT`, `MethodOfPayment`: `TEXT`, `Created`: `DATETIME`, `Updated`: `DATETIME`}
	_                  = bytes.MinRead
)
